...
\input{slides/small_desks}

\input{slides/motivation_merge}
%\input{slides/intro_merge}
\input{slides/which_branch}
\input{slides/create_branch}
\input{slides/fix_branch}
\input{slides/merge_first_branch}
\input{slides/merge_sec_branch}
